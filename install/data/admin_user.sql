...
(1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '{adminpass}', '{adminpepper}', '{adminuser}', '{adminmail}', 1, '', '', 1, 1, 0, NULL, NULL, 'noavatar.png', '', '', 'unknown', '', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 'de', NULL);
...
INSERT INTO `settings` (
  ...
  'nexpell ist ein modernes, modulares CMS für Communities, Esport-Teams und digitale Projekte – mit Plugins, Templates, Tutorials und einfacher Anpassbarkeit.', 
  0, 'startpage'
);
